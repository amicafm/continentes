...
public class tela2 extends Activity {
    public static final String DESCRICAO = "paises.descricao";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(atividade, tela3.class);
    ...
    public ArrayList<String> buscaPaises(String chave){
        ...
        ArrayList<String> africa = geraListaAfrica();
        ArrayList<String> americas = geraListaAmericas();
        ArrayList<String> asia = geraListaAsia();
        ArrayList<String> europe = geraListaEuropa();
        ArrayList<String> oceania = geraListaOceania();
    ...
    public ArrayList<String> geraListaAfrica(){
        ArrayList<String> lista = new ArrayList<>();
        /*
        lista.add("Desktops: Computador da secretária quebrado.");
        lista.add("Telefonia: Telefone não funciona.");
    ...
    public ArrayList<String> geraListaAmericas(){
        ArrayList<String> lista = new ArrayList<>();
        /*
        lista.add("Desktops: Computador da secretária quebrado.");
        lista.add("Telefonia: Telefone não funciona.");
    ...
    public ArrayList<String> geraListaAsia(){
        ArrayList<String> lista = new ArrayList<>();
        /*
        lista.add("Desktops: Computador da secretária quebrado.");
        lista.add("Telefonia: Telefone não funciona.");
    ...
    public ArrayList<String> geraListaOceania(){
        ArrayList<String> lista = new ArrayList<>();
        /*
        lista.add("Desktops: Computador da secretária quebrado.");
        lista.add("Telefonia: Telefone não funciona.");
    ...
    public ArrayList<String> geraListaEuropa() {
        ArrayList<String> lista = new ArrayList<>();
        /*
        lista.add("Desktops: Computador da secretária quebrado.");
        lista.add("Telefonia: Telefone não funciona.");
